	...
	<header>
		<div class="row header-row">
			<div class="col-lg-2 col-sm-3 col-xs-6 logo-outer">
				<a href="index.html" title="Volunteer Overseas" class="logo"><img src="/VolunteerOverseas/resources/images/logo_1.png" alt="">
				<img class="color-logo" src="/VolunteerOverseas/resources/images/logo.png" alt=""></a>
			</div>
